Feature: Positionnement Prof et etudiant 

  Background:
    Given un prof du nom "Max"
    And un prof du nom "Jerome"
    And un module "gestion de projet" sans prof positionné sur lui 
  ...
  Scenario: Prof peut se positionner sur un cours 
    When "Max" veut se positionner sur "gestion de projet"
    Then "Max" est positionné sur "gestion de projet"
...
Scenario: Un etudiant veut ajouter un prof sur un cours 
    ...
    And "Jerome" n'est pas positionné sur "AIGame"
